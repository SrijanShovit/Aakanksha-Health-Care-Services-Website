...
import {AiFillLinkedin,AiFillTwitterCircle,AiFillFacebook,AiFillYoutube,AiFillInstagram} from "react-icons/ai"
        ...
        <hr className="bg-success mb-4 mt-0 d-inline-block mx-auto"  /> 
          ...
          <Col sm>
            <Row className="social-media">
              ...
              <Col>
              <IconContext.Provider value={{ color: "#4c68d7",className:"icons" }}>                
                    <AiFillInstagram />                    
                    </IconContext.Provider>
              </Col>
              <Col>
