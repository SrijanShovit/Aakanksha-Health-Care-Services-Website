...
const Doctorconsultation = () => {
    ...
    const style = { position: "fixed",  left: "50%" ,top:"50%"};
    useEffect(() => {
        function fetchData () {
            Axios.post('http://localhost:5000/doctor/getDoctorDetail')
            .then((response)=>{
    ...
    const searchProduct=()=>{
        ...
        Axios.post('http://localhost:5000/doctor/searchDoctors',
        {
          "searchQuery":keyword,
            "page":1,
            "pageLimit":5
        ...
        <>
            ...
            <Container>
                <div className="input-group searchbox mt-3">
                        <input type="text" className="form-control w3-animate-zoom" placeholder="Zipcode | Doctors Name" onChange={(e)=>{
                    ...
                    <div className="container" align="center">
                        {
                          ...
                          (
                               <div className="col-lg-12 col-12  card">
                                <div className="row mt-3">
                                    <div className="col-lg-4 col-12 doctordetail" style={{ padding: "10px" }} align="center">
                                        <img src={item.imageUrl} className="d-block mt-3 doctorphoto cardgroup" alt="medicine" />
                                    </div>
                                    <div className="col-lg-8 col-12" align="center">
                                        <div className="card-body mt-3" align="left">
